...
const SLIDE_DATA = [
  ...
  { title: "The Aftermath", desc: "Over 1,600 schools across Sri Lanka were damaged by the cyclone, including ones in our own service area. Even when buildings survived, torn roofs, flooded classrooms, and missing supplies have kept children from a normal school day.", image: image4 },
  { title: "The Gap", desc: "Months after the cyclone, national relief funding still falls over $1.5 million short of what is needed for education alone, and supply shipments to affected regions face weeks of delay. In villages like ours, that gap is still being felt in classrooms today.", image: image5 },
